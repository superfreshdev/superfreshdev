    ...
    function updateItProjectCard( checkedProjectIndex ) {
        ...
        if( checkedProjectIndex != -1 ) {
            ...
            /* -------------------------------------------------- */
                ...
                setValueAttribute( 'src', dataTop3Project1.projects[checkedProjectIndex].header.imgSrcCover , img_cover_top3_project_1)

                // SET | Text Project Nr | Text Project Status
                setTextToDomElement( dataTop3Project1.projects[checkedProjectIndex].header.txtProjectNr, div_p1_nr_project_t3 )
                setTextToDomElement( dataTop3Project1.projects[checkedProjectIndex].header.status, div_p1_status_project_t3 )

                // SET | Small IMG SRC & Project Title 
                setValueAttribute( 'src', dataTop3Project1.projects[checkedProjectIndex].header.imgSrcProjectTtile , img_small_p1_project_t3 )
                setTextToDomElement( dataTop3Project1.projects[checkedProjectIndex].header.projectTitle, div_project_title_p1_project_t3 )
